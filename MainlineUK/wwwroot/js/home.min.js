                ...
                <div class="card LatestVehicle">
                    ...
                    <div class="container Details">
                        <div class="row">
                            <div class="col-xl-8 col-6">
                                <a class="OpenVehicle" href="#" data-toggle="modal" data-id="${n[u].stocklistImportID}" data-target="#vehicleModal" data-loading-text="${n[u].make} ${n[u].model} ${n[u].derivative} (${n[u].manufacturedYear})"><h2>${n[u].make} ${n[u].model}</h2></a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <a class="OpenVehicle" href="#" data-toggle="modal" data-id="${n[u].stocklistImportID}" data-target="#vehicleModal" data-loading-text="${n[u].make} ${n[u].model} ${n[u].derivative} (${n[u].manufacturedYear})"><h3>${n[u].derivative} (${n[u].manufacturedYear})</h3></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col text-center MoreDetails">
                            <a class="OpenVehicle" href="#" data-toggle="modal" data-id="${n[u].stocklistImportID}" data-target="#vehicleModal" data-loading-text="${n[u].make} ${n[u].model} ${n[u].derivative} (${n[u].manufacturedYear})">Finance from xxx p/m &gt;</a>
                        </div>
                    </div>
                </div>
