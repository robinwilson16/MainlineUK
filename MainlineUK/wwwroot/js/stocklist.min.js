                            ...
                            <div class="col-md-4 align-self-center">
                                ...
                                <div class="row">
                                    <div class="col text-center MoreDetails">
                                        <a class="OpenVehicle" href="#" data-toggle="modal" data-id="${t[n].stocklistImportID}" data-target="#vehicleModal" data-loading-text="${t[n].make} ${t[n].model} ${t[n].derivative} (${t[n].manufacturedYear})">
