...
namespace MainlineUK.Data.Migrations
{
    ...
    [Migration("20181019194836_StocklistDefaultDate")]
    partial class StocklistDefaultDate
    {
            ...
            modelBuilder.Entity("MainlineUK.Models.StocklistImport", b =>
                {
                    ...
                    b.Property<DateTime>("DateImported")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 10, 19, 20, 48, 36, 242, DateTimeKind.Local));
