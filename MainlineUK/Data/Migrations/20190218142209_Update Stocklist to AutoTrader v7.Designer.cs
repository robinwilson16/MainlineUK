...
namespace MainlineUK.Data.Migrations
{
    ...
    [Migration("20190218142209_Update Stocklist to AutoTrader v7")]
    partial class UpdateStocklisttoAutoTraderv7
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MainlineUK.Models.CarRequestSell", b =>
                {
                    b.Property<int>("CarRequestSellID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CarRequestSellID");

                    b.ToTable("CarRequestSell");
                });

            modelBuilder.Entity("MainlineUK.Models.Photo", b =>
                {
            ...
            modelBuilder.Entity("MainlineUK.Models.StocklistImport", b =>
                {
                    ...
                    b.Property<string>("OtherVehicleText")
                        .HasMaxLength(500);
            ...
            modelBuilder.Entity("MainlineUK.Models.Photo", b =>
                {
                    b.HasOne("MainlineUK.Models.StocklistImport", "StocklistImport")
                        .WithMany("Photo")
                        .HasForeignKey("StocklistImportID");
                });
